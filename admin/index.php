...
// Основная страница - по умолчанию settings
...
<head>
  ...
  <style>
    ...
    */
     /* Отступ для подпунктов настроек */
     .collapse .nav-column.ms-3 .nav-item .nav-link { padding-left: 1.5rem !important; }
  </style>
</head>
<body>
  ...
  <div class="row flex-nowrap">
    ...
    <div class="col py-4">
      ...
      <?php
        ...
        // Удален timezone_settings
        $allowed = ["dashboard", "settings", "email_settings", "proxy", "admin", "diagnostics", "logs", "models", "limits", "chat_ttl"]; // Обновлен список разрешенных
        $page = $_GET["page"] ?? "settings"; // Определение страницы после массива allowed, по умолчанию settings
